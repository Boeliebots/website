...
export const NEXT_EVENT = '15 march 2026';
export const CLOSE_DAYS_BEFORE_EVENT = 99; // Number of days before the event that the site should be closed for new registrations
