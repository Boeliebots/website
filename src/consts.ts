...
export const NEXT_EVENT = '16 november 2025';
export const CLOSE_DAYS_BEFORE_EVENT = 3; // Number of days before the event that the site should be closed for new registrations
export const LIVESTREAM_URL = 'https://www.youtube.com/live/Th3bJ8Tgdno';